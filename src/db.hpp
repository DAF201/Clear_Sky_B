...
// connect to database
int db::connect_to_db(std::map<std::string, std::string> *database_config)
{
...
void db::database_selection_check(std::string target_database)
{
...
bool db::database_execute(std::string target_database, std::string query)
{
    db::database_selection_check(target_database);
...
sql::ResultSet *db::database_execute_query(std::string target_database, std::string query)
{
    db::database_selection_check(target_database);
...
std::list<std::map<std::string, void *>> db::database_query_result_resolve(sql::ResultSet *result, std::string **ids, std::string schema)
{
...
void db::database_query_result_recycle(std::list<std::map<std::string, void *>> result_list)
{
